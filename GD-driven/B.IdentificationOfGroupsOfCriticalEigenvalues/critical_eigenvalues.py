...
df_real=pd.read_excel('../A.DataGeneration/TrainingData/DataSet/real_parts_eigenvalues_LHS10_10_nreg9.xlsx')
df_imag=pd.read_excel('../A.DataGeneration/TrainingData/DataSet/imag_parts_eigenvalues_LHS10_10_nreg9.xlsx')
...
inputs=pd.read_excel('../A.DataGeneration/TrainingData/DataSet/training_data_LHS10_10_nreg9.xlsx')
inputs['DI_crit']=DI_crit_eig
pd.DataFrame.to_csv(inputs,'Training_inputs_DI_crit_LHS10_10_nreg9.csv', index=False)
...
ax.set_title('Complete Modal Map', fontsize=25)
ax.tick_params(labelsize=20)
ax.legend(loc='lower center',bbox_to_anchor=(0.45, -0.5),fontsize=15, ncol=2)
fig.tight_layout()
plt.grid()
...
inputs=pd.read_excel('../A.DataGeneration/TestData/Data Set'+obj_fun+'/test_data_OPF_'+obj_fun+'.xlsx')
inputs['DI_crit']=DI_crit_eig
