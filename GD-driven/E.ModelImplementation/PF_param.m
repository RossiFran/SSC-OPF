...
dat.Y55 = (1/(Rac+i*Xac)+i*Bac+1/Rd50)*Zb;%+dat.SG2.Ysgsg;
dat.Y66 = (4/(Rac+i*Xac)+i*4*Bac+1/Rd60)*Zb;%+dat.SG1.Ysgsg;
dat.Y77 = (2/(Rac+i*Xac)+i*2*Bac+1/Rd70)*Zb;
dat.Y88 = (3/(Rac+i*Xac)+i*3*Bac+1/Rd80)*Zb;
dat.Y99 = (1/(Rac+i*Xac)+i*Bac+1/Rd90)*Zb;

dat.Yii =[dat.Y11 dat.Y22 dat.Y33 dat.Y44 dat.Y55 dat.Y66 dat.Y77 dat.Y88 dat.Y99];% dat.SG2.Ysgsg dat.SG1.Ysgsg];