% function F = f_powerflow(x,dat)
function [c,ceq] = f_powerflow(x,dat)
...
ceq(21) = P5 - (Pe5bx+dat.SG2.kfd_sg/100e6*(50-f)); %Frequency droop SG2 
ceq(22) = P6 - (Pe6bx+dat.SG1.kfd_sg/100e6*(50-f)); %Frequency droop SG1 
