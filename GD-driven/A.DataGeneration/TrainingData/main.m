...
if plot_datagen_2d==1 && save_plot_datagen ==1
    ...
    saveas(gcf,'Data Set\Training_DataSet_GD.png')
end
...
filename=(['Data Set\training_data_LHS',num2str(nlhs),'_',num2str(nlhs2),'_nreg',num2str(nreg),'.xlsx']);
writetable(training_data, filename);

real_eig_table=array2table(real_parts_eig);
filename=(['Data Set\real_parts_eigenvalues_LHS',num2str(nlhs),'_',num2str(nlhs2),'_nreg',num2str(nreg),'.xlsx']);
writetable(real_eig_table,filename);

imag_eig_table=array2table(imag_parts_eig);
filename=(['Data Set\imag_parts_eigenvalues_LHS',num2str(nlhs),'_',num2str(nlhs2),'_nreg',num2str(nreg),'.xlsx']);
