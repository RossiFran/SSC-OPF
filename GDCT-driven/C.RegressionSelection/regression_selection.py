...
Training_data=pd.read_csv('../B.IdentificationOfGroupsOfCriticalEigenvalues/Training_inputs_DI_crit_LHS10_20_nreg9.csv').drop(['Iter_num','DI','PLTOT','f','Exitflag'],axis=1)
