...
Training_data=pd.read_csv('../B. Identification of groups of critical eigenvalues/Training_inputs_DI_crit_LHS10_20_nreg9.csv').drop(['Iter_num','DI','PLTOT','f','Exitflag'],axis=1)
...
models_dict={'LR': LinearRegression(),'Lasso': Lasso(alpha=1),'Ridge': Ridge(alpha=0.1),'ElasticNet': ElasticNet()}
...
for obj_fun in ['Min_P_SG','Min_P_losses']:
    ...
    r2_mars=r2_score(ytest,pred_mars)
