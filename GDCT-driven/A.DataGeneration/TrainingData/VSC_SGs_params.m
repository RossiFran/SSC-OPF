...
kfd_vsc = Sn/(50*Rdroop); % Droop convertidor

% Demand
Pd20 = stress_dir(jj_samples,1)*Pd_tot;
Pd30 = stress_dir(jj_samples,2)*Pd_tot;
Pd40 = stress_dir(jj_samples,3)*Pd_tot;
Pd50 = stress_dir(jj_samples,4)*Pd_tot;
Pd60 = stress_dir(jj_samples,5)*Pd_tot;
Pd70 = stress_dir(jj_samples,6)*Pd_tot;
Pd80 = stress_dir(jj_samples,7)*Pd_tot;
Pd90 = stress_dir(jj_samples,8)*Pd_tot;
...
%Generator 1
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
kd_sg1=0.05;%kd_sg1_arr(jj);
SG1.kfd_sg = SG1.Pn/(50*kd_sg1); %Ganancia droop del generador síncrono (MW/Hz)
...
%Generator 2
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
kd_sg2=0.05;%kd_sg2_arr(jj);
SG2.kfd_sg = SG2.Pn/(50*kd_sg2); %Ganancia droop del generador síncrono (MW/Hz)
